    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 fade-up">
          ...
          <div className="w-16 h-0.5 bg-white mx-auto my-6 fade-in"></div>
          <p className="italic text-lg md:text-xl text-white/80 fade-in">
      ...
      <section className="bg-yellow-100 text-center py-16 px-4 h-auto">
        ...
        <p className="max-w-3xl mx-auto text-gray-800 text-base leading-relaxed font-serif fade-up">
